          ...
          <div class="container">
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				if($_SESSION['role'] == 'admin'){
                    ...
                    echo("<li><p class='navbar-text'> <span class='glyphicon glyphicon-shopping-cart'> </span> <a href='index.php?page=Admin'> Commande </a></p></li>");
				}
                elseif($_SESSION['role'] != 'invite'){
					echo("<li><p class='navbar-text'> <span class='glyphicon glyphicon-user'></span> ".$_SESSION['role']." </p></li>");
					echo("<li><p class='navbar-text'> <span class='glyphicon glyphicon-log-in'> </span> <a href='index.php?page=Deconnexion'> Déconnexion </a> </p></li>");
					echo("<li><p class='navbar-text'> <span class='glyphicon glyphicon-shopping-cart'> </span> <a href='index.php?page=Panier'> Panier </a></p></li>");
				}
                else{
